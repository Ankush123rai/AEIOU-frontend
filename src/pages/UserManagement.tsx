    ...
    <Layout title="User Management">
      <div className="space-y-6 animate-fade-in">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="sm:text-2xl text-xl font-poppins font-bold text-gray-900">User Management</h2>
            <p className="text-gray-600 sm:text-base text-sm font-inter">Manage students, teachers, and administrators</p>
          </div>
          <button
          ...
          >
            ...
            <span className='sm:text-base text-[8px]'>Add User</span>
          </button>
        </div>
...
<div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
  <div className="relative">
    ...
    <input
      ...
      className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent font-inter"
    />
  </div>
  ...
  <div className="flex flex-col sm:flex-row gap-4 sm:items-center justify-between">
    <div className="flex gap-3">
      <select
        ...
        className="flex-1 border border-gray-300 rounded-xl px-3 py-2 focus:ring-2 focus:ring-primary-500 focus:border-transparent font-inter"
      >
